...
function MessageArea() {
  ...
  return (
    <div className={`lg:w-[70%] ${selectedUser?"flex":"hidden"} hidden w-full lg:flex h-full bg-slate-200  border-l-2 border-gray-300 `}>
      {selectedUser && 
      <div className='w-full h-[100px] bg-[#1b9fcb] rounded-b-[30px] shadow-gray-400 shadow-lg gap-[20px] flex items-center px-[20px]'>
        ...
        <div className='w-[45px] h-[45px] rounded-full overflow-hidden flex items-center justify-center shadow-gary-500 shadow-lg'>
